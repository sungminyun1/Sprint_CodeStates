...
*/
const PART4_3 = `INSERT INTO user (name, email) VALUES ('KIM', 'minjman2659@gmail.com')`;
...
// FROM A LEFT JOIN B ON A.key = B.key   ==>  A의 모든 값이 다 출력(Null값 포함)
/*
----------------------------------------------------------------------------------------------
    TODO: Q 4-8. content의 title과 그 컨텐츠를 작성한 user의 name을 찾기 위한 SQL을 작성해주세요.
        - 저자가 있는 컨텐츠의 title만 찾아야합니다.
*/
const PART4_8 = `SELECT content.title, user.name FROM user JOIN content ON user.id = content.userId`;
...
*/
const PART4_10 = `INSERT INTO content (title, body, userId) VALUES ('database damn', 'IT!', 1)`;
